...
class BillController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        'total_amount' => (int)$request->get('admission_fee_amount')+(int)$request->get('share_money_amount')+(int)$request->get('cost_of_land_amount')+(int)$request->get('cost_of_corner_amount')+(int)$request->get('lease_documentation_amount')+(int)$request->get('cost_of_development_amount')+(int)$request->get('cost_of_transfer_amount')+(int)$request->get('establishment_charges_amount')+(int)$request->get('miscellaneous_amount')+(int)$request->get('cost_of_forms_amount')+(int)$request->get('cost_of_road_facing_amount')+(int)$request->get('cost_of_extra_land_facing_amount')+(int)$request->get('cost_of_west_open_amount')+(int)$request->get('cost_of_park_facing_amount'),
        'total_received' => (int)$request->get('admission_fee_received')+(int)$request->get('share_money_received')+(int)$request->get('cost_of_land_received')+(int)$request->get('cost_of_corner_received')+(int)$request->get('lease_documentation_received')+(int)$request->get('cost_of_development_received')+(int)$request->get('cost_of_transfer_received')+(int)$request->get('establishment_charges_received')+(int)$request->get('miscellaneous_received')+(int)$request->get('cost_of_forms_received')+(int)$request->get('cost_of_road_facing_received')+(int)$request->get('cost_of_extra_land_facing_received')+(int)$request->get('cost_of_west_open_received')+(int)$request->get('cost_of_park_facing_received')+(int)$request->get('adjust_amount'),
