...
$('#cost_of_extra_land_facing_amount').val({{ $bill->cost_of_extra_land_facing_amount }});
$('#cost_of_extra_land_facing_received').val({{ $bill->cost_of_extra_land_facing_received }});
$('#cost_of_extra_land_facing_balance').val({{ $bill->cost_of_extra_land_facing_balance }});
